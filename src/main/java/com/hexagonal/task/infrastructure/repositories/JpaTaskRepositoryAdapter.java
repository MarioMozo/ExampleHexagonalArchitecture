...
public class JpaTaskRepositoryAdapter implements TaskRepositoryPort {
    ...
    public Task save(Task task) {
        //aqui se enchufa con el domainModel
        TaskEntity taskEntity = TaskEntity.fromDomainModel(task);
        //aqui se guarda con el metodo save lo que hay en la variable taskEntity de arriba
        TaskEntity savedTaskEntity = jpaTaskRepository.save(taskEntity);
        return savedTaskEntity.toDomainModel(); //Este metodo vienen de TaskEntity
    }
