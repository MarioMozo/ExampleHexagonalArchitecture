...
public class ExternalServiceAdapter implements ExternalServicePort {
    ...
    public AdditionalTaskInfo getAdditionalTaskInfo(Long taskId) {
        ...
        ResponseEntity<JsonPlacerHolderTodo> response = restTemplate.getForEntity(apiUrl, JsonPlacerHolderTodo.class);
        JsonPlacerHolderTodo todo = response.getBody();
     ...
     private static class JsonPlacerHolderTodo{
        private Long id;
        private Long userId;
